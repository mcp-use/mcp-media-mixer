...
const server = new MCPServer({
  ...
  title: "Media Mixer",
  version: "1.0.0",
  description: "Response helpers showcase \u2014 every content type (image, audio, binary, html, xml, css, js)",
...
server.tool(
  {
    name: "generate-audio",
    description: "Generate a tiny WAV file (1 s of silence at 8 kHz, 8-bit mono).",
    schema: z.object({}),
    annotations: { readOnlyHint: true }
  },
  async () => {
...
server.tool(
  {
    name: "get-report",
    description: "Return a mixed response combining text, markdown, and an embedded resource.",
    schema: z.object({}),
    annotations: { readOnlyHint: true }
  },
  async () => {
...
server.tool(
  ...
  async () => {
    return html(
      "<div style='padding:16px;background:#f0f9ff;border-radius:8px;font-family:sans-serif'><h2 style='color:#1e40af;margin:0'>HTML Content</h2><p style='color:#3b82f6'>Rendered via the <code>html()</code> response helper.</p></div>"
    );
  }
);
server.tool(
...
server.tool(
  {
    name: "get-script",
    description: "Return a JavaScript snippet via the javascript() response helper.",
    schema: z.object({}),
    annotations: { readOnlyHint: true }
  },
  async () => {
...
server.tool(
  {
    name: "content-error",
    description: "Demonstrate the error() response helper by returning a deliberate failure.",
    schema: z.object({}),
    annotations: { readOnlyHint: true }
  },
  async () => {
